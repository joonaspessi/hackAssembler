...
const SourceL = readSourceFile(path.join(path.dirname(__filename), "../../pong/PongL.asm"));
const OutputL = readOutputFile(path.join(path.dirname(__filename), "../../pong/PongL.hack"));

const Source = readSourceFile(path.join(path.dirname(__filename), "../../pong/Pong.asm"));
const Output = readOutputFile(path.join(path.dirname(__filename), "../../pong/Pong.hack"));

describe('Pong assembly', function() {
